...
export const NotificationsDrawer = ({ notifications, open, onOpenChange, onDismiss, onClearAll }: NotificationsDrawerProps) => {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-md p-0 flex flex-col gap-0" side="right">
        ...
        <SheetFooter className="px-6 py-3 border-t border-border bg-white flex flex-row justify-between items-center sm:justify-between">
